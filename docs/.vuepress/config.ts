...
export default defineUserConfig({
  ...
  head: [
    ...
    // seo
    ['meta', { name: 'keywords', content: 'smart picture, AI picture, picture documentation' }],
    // ['meta', { name: 'author', content: 'me@qjidea.com' }],
    ['meta', { property: "og:url", content: 'https://vaiui.com/' }],
    ...
    [
      ...
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-8XT9GKLKYD",
      },
    ],
    [
      "script",
      {},
      "window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);} gtag('js', new Date());gtag('config', 'G-8XT9GKLKYD');"
    ],
    // google ads
    // [
    //   "script",
